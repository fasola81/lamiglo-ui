    ...
    >
      <defs>
        ...
        <radialGradient id="hero-copper-glow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="rgba(255,138,101,0.25)" />
        ...
        <linearGradient id="hero-line-copper" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="rgba(255,138,101,0)" />
      ...
      <g className="hero-circuits" opacity="0.4">
        ...
        {[[250,120],[350,200],[200,300],[300,380],[200,180],[400,220]].map(([x,y], i) => (
          <circle key={`junc-${i}`} cx={x} cy={y} r="3" fill={i % 2 === 0 ? 'rgba(168,85,247,0.4)' : 'rgba(255,138,101,0.35)'}>
      ...
      <g className="hero-neural-core">
        ...
        {/* Inner ring */}
        <circle cx="300" cy="250" r="45" fill="none" stroke="rgba(168,85,247,0.15)" strokeWidth="1">
          <animateTransform attributeName="transform" type="rotate" values="0 300 250;360 300 250" dur="30s" repeatCount="indefinite" />
        </circle>
        <circle cx="300" cy="250" r="32" fill="none" stroke="rgba(255,138,101,0.1)" strokeWidth="0.8" strokeDasharray="6 4">
          <animateTransform attributeName="transform" type="rotate" values="360 300 250;0 300 250" dur="25s" repeatCount="indefinite" />
        </circle>

        {/* Central brain node */}
        <circle cx="300" cy="250" r="12" fill="rgba(168,85,247,0.15)" stroke="rgba(168,85,247,0.5)" strokeWidth="1.5" filter="url(#hero-glow-filter)">
          <animate attributeName="r" values="10;14;10" dur="4s" repeatCount="indefinite" />
        </circle>
        <circle cx="300" cy="250" r="5" fill="rgba(168,85,247,0.8)">
          <animate attributeName="r" values="4;6;4" dur="3s" repeatCount="indefinite" />
        </circle>

        {/* Satellite nodes orbiting — positions hardcoded to avoid SSR hydration mismatch */}
        {[
          { x: 345, y: 250, color: 'rgba(168,85,247,0.7)', dur: '3s' },
          { x: 322.5, y: 288.97, color: 'rgba(255,138,101,0.7)', dur: '3.3s' },
          { x: 277.5, y: 288.97, color: 'rgba(168,85,247,0.7)', dur: '3.6s' },
          { x: 255, y: 250, color: 'rgba(255,138,101,0.7)', dur: '3.9s' },
          { x: 277.5, y: 211.03, color: 'rgba(168,85,247,0.7)', dur: '4.2s' },
          { x: 322.5, y: 211.03, color: 'rgba(255,138,101,0.7)', dur: '4.5s' },
        ].map((sat, i) => (
          <g key={`sat-${i}`}>
        ...
        {[
          { x1: 351.96, y1: 280, x2: 387.94, y2: 288.88, stroke: 'rgba(168,85,247,0.12)', fill: 'rgba(168,85,247,0.4)' },
          { x1: 300, y1: 310, x2: 297.41, y2: 350, stroke: 'rgba(255,138,101,0.1)', fill: 'rgba(255,138,101,0.3)' },
          { x1: 248.04, y1: 280, x2: 212.06, y2: 288.88, stroke: 'rgba(168,85,247,0.12)', fill: 'rgba(168,85,247,0.4)' },
          { x1: 248.04, y1: 220, x2: 212.06, y2: 211.12, stroke: 'rgba(255,138,101,0.1)', fill: 'rgba(255,138,101,0.3)' },
          { x1: 300, y1: 190, x2: 297.41, y2: 150, stroke: 'rgba(168,85,247,0.12)', fill: 'rgba(168,85,247,0.4)' },
          { x1: 351.96, y1: 220, x2: 387.94, y2: 211.12, stroke: 'rgba(255,138,101,0.1)', fill: 'rgba(255,138,101,0.3)' },
        ].map((conn, i) => (
          <g key={`outer-${i}`}>
      ...
      <g className="hero-code-symbols">
        {/* < > brackets */}
        <text x="0" y="0" fill="rgba(168,85,247,0.35)" fontSize="22" fontFamily="monospace" fontWeight="300">
          &lt; /&gt;
        ...
        {/* { } curly braces */}
        <text x="0" y="0" fill="rgba(255,138,101,0.3)" fontSize="20" fontFamily="monospace" fontWeight="300">
          {'{ }'}
        ...
        {/* AI text */}
        <text x="0" y="0" fill="rgba(255,138,101,0.25)" fontSize="16" fontFamily="monospace" fontWeight="600">
          AI
        ...
        {/* 01 binary */}
        <text x="0" y="0" fill="rgba(168,85,247,0.2)" fontSize="14" fontFamily="monospace">
          01
      ...
      <g className="hero-data-particles">
        {[
          ...
          <circle key={`dp-${i}`} r="1.5" fill={p.color === 'cyan' ? 'rgba(168,85,247,0.8)' : 'rgba(255,138,101,0.7)'}>
